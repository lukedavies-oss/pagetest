      ...
      <section className="grid gap-6 md:grid-cols-2">
        <Card>
          <div className="space-y-2">
            ...
            <p className="text-base text-ink/80 dark:text-white/80">Calle San Fernando 12, 41004 Seville</p>
            <p className="text-base text-ink/80 dark:text-white/80">hello@andaluciagroup.com</p>
          ...
          <div className="mt-4 space-y-2">
            ...
            <p className="text-base text-ink/80 dark:text-white/80">Monday to Friday 09:00 – 18:00</p>
          </div>
        </Card>
        <Map lat={37.3838} lng={-5.9901} title="Andalucía Group" />
      </section>

      <section className="rounded-3xl bg-white/90 p-8 shadow-soft dark:bg-neutral-900/80">
        <ContactForm labels={formLabels} locale="en" />
      </section>
    </div>
  );
}
